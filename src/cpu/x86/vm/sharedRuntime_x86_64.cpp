...
static void gen_i2c_adapter(MacroAssembler *masm,
...

  {
#ifdef ASSERT
    {
      ...
      Label not_old;
      __ movl(r13, Address(rbx, Method::access_flags_offset()));
      __ andl(r13, JVM_ACC_IS_OLD);
      __ testl(r13, r13);
    ...
    Label no_check;
    __ push(r13);
    __ movl(r13, Address(rbx, Method::dsu_flags_offset()));
    __ andl(r13, DSU_FLAGS_MEMBER_NEEDS_STALE_OBJECT_CHECK);
    __ testl(r13, r13);
    __ pop(r13);
    __ jcc(Assembler::zero, no_check);
    {
      __ movptr(r13, Address(saved_sp, total_args_passed*Interpreter::stackElementSize));
      __ null_check(r13);

      __ load_klass(r13, r13);
      __ verify_oop(r13);
      __ movl(r13, Address(r13, Klass::dsu_flags_offset()));
      __ andl(r13, DSU_FLAGS_CLASS_IS_STALE_CLASS);
